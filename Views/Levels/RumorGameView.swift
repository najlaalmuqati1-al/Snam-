// الpopup بالبداية حجمها صغير النص فيها مو طالع بالكامل
// تعديل ايضا متعلق باللوجك ، مفروض الشارت تكون ثابته مع نفس الاشاعة بمعنى الاشاعة عن النفط الشارت يفضل تكون عن قطاع الطاقة 
import SwiftUI
